...
public class ColorHandlers {
    ...
    public static final IBlockColor BLOCK_BLOOD_LEAF = (state, worldIn, pos, tintIndex) -> worldIn != null && pos != null ? blendColors(0xB70606, BiomeColorHelper.getFoliageColorAtPos(worldIn, pos)) : blendColors(0xB70606, ColorizerFoliage.getFoliageColor(0.5D, 1.0D));
    public static final IBlockColor BLOCK_FOLIAGE = (state, worldIn, pos, tintIndex) -> worldIn != null && pos != null ? BiomeColorHelper.getFoliageColorAtPos(worldIn, pos) : ColorizerFoliage.getFoliageColor(0.5D, 1.0D);
    ...
    public static final IItemColor ITEM_FOLIAGE = (stack, tintIndex) -> BLOCK_FOLIAGE.colorMultiplier(((ItemBlock) stack.getItem()).getBlock().getDefaultState(), null, null, tintIndex);
    public static final IItemColor ITEM_BLOOD_LEAF = (stack, tintIndex) -> BLOCK_BLOOD_LEAF.colorMultiplier(((ItemBlock) stack.getItem()).getBlock().getDefaultState(), null, null, tintIndex);
