...
public class BucketsUtils {
    @Nonnull
    static FluidActionResult tryPlaceFluid(@Nullable EntityPlayer player, World world, BlockPos pos, @Nonnull ItemStack container, FluidStack resource) {
    ...
    private static boolean tryPlaceFluid(@Nullable EntityPlayer player, World world, BlockPos pos, IFluidHandler fluidSource, FluidStack resource) {
    ...
    public static IFluidHandler getBlockFluidHandler(Fluid fluid, World world, BlockPos pos) {
        ...
        if (block instanceof IFluidBlock) {
            return new BucketFluidBlockWrapper((IFluidBlock) block, world, pos);
        } else if (block instanceof BlockLiquid) {
            return new BucketLiquidWrapper((BlockLiquid) block, world, pos);
        }
        return null;
    }
    ...
    public static IFluidHandler getBlockFluidHandler(World world, BlockPos blockPos, EnumFacing side) {
        ...
        if (block instanceof IFluidBlock) {
            return new BucketFluidBlockWrapper((IFluidBlock) block, world, blockPos);
        } else if (block instanceof BlockLiquid) {
            return new BucketLiquidWrapper((BlockLiquid) block, world, blockPos);
        }
