...
public final class BWMItems {
    ...
    //Other
    public static final Item CREEPER_OYSTER = (new ItemFood(2, false).setPotionEffect(new PotionEffect(MobEffects.POISON, 100, 0), 1)).setRegistryName("creeper_oyster");
    public static final Item KIBBLE = new ItemFood(3, 0, true).setPotionEffect(new PotionEffect(MobEffects.HUNGER, 600, 0), 0.3F).setRegistryName("kibble");
    ...
    public static final Item COOKED_OMELET = new ItemFood(4, 1, false).setRegistryName("cooked_omelet");

    public static final Item HAM_AND_EGGS = new ItemFood(6, 1, false).setRegistryName("ham_and_eggs");
