...
public class FatPenalties extends PenaltyHandler<Float, BasicPenalty<Float>> {
    ...
    public FatPenalties() {
        ...
        addPenalty(new BasicPenalty<>(true, true, true, false, true, false, 1f, 1 / 4f, "plump", "bwm.fat_penalty.plump", category, Range.between(37f, 42f)));
        addPenalty(new BasicPenalty<>(true, true, true, false, true, false, 1f, 2 / 4f, "chubby", "bwm.fat_penalty.chubby", category, Range.between(43f, 48f)));
        addPenalty(new BasicPenalty<>(false, false, false, false, true, false, 0.5f, 3 / 4f, "fat", "bwm.fat_penalty.fat", category, Range.between(49f, 52f)));
